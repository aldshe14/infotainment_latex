...
Die Tabellen Kalenderinformationen und Stundenplan wurden aus der Datenbank selektiert und dann mit PHP dargestellt. Die Kalenderinformationen sind auf die Abbildung 1.3 ersichtlich. Die leere Klassen sind durch die Erstellung von einer View f\"ur die Tabelle Unterricht dargestellt. Die leere Klassen sind auf die Abbildung 1.4 ersichtlich. F\"ur den Supplierplan wurde eine gespeicherte Prozedur erstellt.
...
\captionsetup{type=figure}
 \captionsetup{type=figure}
 \includegraphics[width=\linewidth]{\ordnerfigures leereklassen.jpg}
