...
\end{itemize}
\section{Layout}
Es werden verschiedene Layouts f\"ur die Anzeige zur Verf\"ugung gestellt. Auf Abbildung 1.3 ist ein Beispiel ersichtlich, wobei die Anzeige in vier Teilbereichen geteilt wird. Der kleinste Bereich, der oben steht ist f\"ur die Darstellung von Uhr und Datum geeignet. In dem grossen Bereich werden z.B. der Stundenplan oder Supplierplan dargestellt. Die anderen Bereiche dienen f\"ur die Darstellung von der letzten Post der Webseite der Schule und f\"ur die Wetter Daten.
Auf Abbildung 1.4 ist ein anderes Beispiel ersichtlich. In diesem Fall wird die Anzeige in Vollbildmodus dargestellt. Hier k\"onnen z.B. die Chatbot-Bilder angezeigt werden.
\begin{center}
	\captionsetup{type=figure}
...
Die Tabellen Kalenderinformationen und Stundenplan wurden aus der Datenbank selektiert und dann mit PHP dargestellt. Die Kalenderinformationen sind auf die Abbildung 1.5 ersichtlich. Die leere Klassen sind durch die Erstellung von einer View f\"ur die Tabelle Unterricht dargestellt. Die leere Klassen sind auf die Abbildung 1.6 ersichtlich. F\"ur den Supplierplan wurde eine gespeicherte Prozedur erstellt.
Auf die Abbildung 1.7 ist die Darstellung der Wetterdaten auf dem Bildschirm ersichtlich. \\
\\
\captionsetup{type=figure}
\includegraphics[width=\linewidth]{\ordnerfigures kale.jpg}
